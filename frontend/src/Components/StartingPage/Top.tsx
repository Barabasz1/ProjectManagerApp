  ...
  return (
    ...
    <Box className="bg-gradient-to-b from-[var(--c6)] to-[var(--c5)]  p-12 text-center items-center flex flex-col gap-4">
        ...
        <div className='flex gap-4'>
         ...
         <button className="bg-[var(--c6)] hover:bg-[var(--c5)] text-white font-medium py-2 px-4 w-32 h-12 rounded-lg shadow transition duration-500 ease-in-out " > REGISTER</button>
        </div>
