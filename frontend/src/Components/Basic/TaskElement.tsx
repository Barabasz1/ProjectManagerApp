...
const TaskElement = ({task}) => {
    ...
    const {IncreaseStatus, DecreaseStatus, removeTask} = useTasksContext()
  ...
  return (
    <>
      ...
      <button 
        ...
        className="absolute top-2 right-2 hover:cursor-pointer bg-red-700 hover:bg-red-600 text-white rounded-full w-4 h-4 flex items-center justify-center transition-colors duration-300 z-10"
      >
        X
      </button>
